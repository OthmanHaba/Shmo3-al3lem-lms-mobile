  ...
  return (
    <TouchableOpacity onPress={onPress} className="flex-row p-4 rounded-lg bg-white shadow-md mb-4 items-center">
      ...
      <View className="flex-1">
        ...
        <Text className="text-sm font-primary text-gray-600 mb-1 text-right">{course.teacher.full_name}</Text>
        <View className="flex-row items-center mb-1 justify-end">
          <FontAwesome name="star" size={16} color="gold" />
          <Text className="text-sm font-primary ml-1 mr-2 text-gray-800">{course.rate}</Text>
        </View>
